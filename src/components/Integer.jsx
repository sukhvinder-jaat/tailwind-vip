    ...
    <>
      <section className="lg:py-28 py-12 bg-[#FEFEFE]">
        <div className="container mx-auto px-3">
          <p className=" font-KonexyPersonalUse font-normal text-3xl md:text-5xl text-black mb-lg-5 mb-4 md:mb-14">
            Integer et nisl non
          </p>
              ...
              return (
                ...
                >
                  <div className="bg-white border border-solid border-[#E5E5E5] lg:p-9 p-4 rounded-2xl hover:shadow-[0_20px_60px_0_#E5E9F6] transition-all duration-300 ease-linear flex flex-col items-center h-full">
                    <img src={PPC.svg} />
                    <p className="font-inter font-semibold text-xl sm:text-2xl text-center mt-3 lg:mt-12 max-w-[332px]">
                      {PPC.heading}
                    </p>
                    <p className="font-gilroyMedium font-normal text-sm sm:text-base text-center text-black opacity-70 my-3 lg:my-4 pt-1 max-w-[333px]">
                      {PPC.para}
                    </p>
                    <a
                      href="#"
